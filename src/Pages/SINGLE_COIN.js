...
import PRICE_CHART from '../components/Chart/PRICE_CHART'
import { PRICE_HISTORY } from '../components/PRICE_HISTORY'
import SINGLE_BAR from '../components/SINGLE_BAR'
import SINGLE_COIN_COMMUNITY from '../components/SINGLE_COIN_COMMUNITY'
      ...
      {status !== 200 ? (
        ...
        <div className='parent-grid'>
          <h2 className='coin-name'>
            <img src={coin?.image?.small} alt='coin representative symbol' />
            {coin?.name}
          </h2>
          ...
          <div className='price-history-container'>
            <PRICE_HISTORY
              ...
              pubdata={coin.public_interest_stats}
              name={coin.name}
            />
          </div>
        </div>
